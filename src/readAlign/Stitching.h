...
namespace rna {
    ...
    class Stitching {
    public:
        explicit Stitching(const StitchingConfig &config, const GenomeIndex &);
    ...
    private:
        ...
        inline bool assignSingleAlignment(Window &win, const PositiveStrandAlign &a, int64_t isj = -1) const;
        ...
        void stitchWindowsAlignSingle(Window &window);

        void stitchWindowsAlignPaired(Window &window);

        void stitchBetweenFragments(const RawTranscript &t1,const RawTranscript&t2,RawTranscript &record);
        ...
        FragmentStitchingRecord* allFragmentStitchingRecord_; // stitching records between fragments
        ...
        static constexpr int MAX_MISMATCH_FOR_SJ[4] = {0, -1, 0,
